...
const en: Dictionary = {
  ...
  langName: "English",
  brand: "Guardian402",
  tagline: "Is that boleto the real one?",
  heroSupport:
  ...
  flowSupport: "One verification - from any ERP or agent - is one measurable USDC payment.",
  flowSteps: [
  ...
  statuses: [
    { code: "AUTHENTIC", label: "Data matches the active integrity proof registered on-chain" },
...
const pt: Dictionary = {
  ...
  langName: "Portugues",
  brand: "Guardian402",
  tagline: "Esse boleto e mesmo o verdadeiro?",
  heroSupport:
    "API paga por uso que confere se os dados de um boleto - de qualquer ERP, sistema de faturamento ou agente, incluindo o TOTVS Protheus - correspondem a uma prova de integridade no Soroban. Um ERP, CLI ou agente de IA paga 0,01 USDC via x402 por chamada. Sem API key, sem assinatura.",
  ...
  whyPoints: [
    "Contexto: um boleto de qualquer ERP ou agente - incluindo o TOTVS Protheus - precisa de uma checagem independente de integridade antes de confiar ou pagar.",
  ...
  flowSupport: "Cada verificacao - de qualquer ERP ou agente - e um pagamento mensuravel em USDC.",
  flowSteps: [
  ...
  statuses: [
    { code: "AUTHENTIC", label: "Dados batem com a prova de integridade ativa registrada on-chain" },
...
const es: Dictionary = {
  ...
  langName: "Espanol",
  brand: "Guardian402",
  tagline: "Ese boleto es realmente el verdadero?",
  heroSupport:
    "API de pago por uso que comprueba si los datos de un boleto - de cualquier ERP, sistema de facturacion o agente, incluido TOTVS Protheus - coinciden con una prueba de integridad en Soroban. Un ERP, CLI o agente de IA paga 0,01 USDC via x402 por llamada. Sin API key, sin suscripcion.",
  ctaGithub: "Abrir repositorio",
  ctaContract: "Ver contrato",
  ctaGuardian: "Guardian Labs",
  ctaReference: "Boleto Guardian",
  ...
  whyPoints: [
    "Contexto: un boleto de cualquier ERP o agente - incluido TOTVS Protheus - necesita una comprobacion independiente de integridad antes de confiar o pagar.",
  ...
  flowSupport: "Cada verificacion - de cualquier ERP o agente - es un pago medible en USDC.",
  flowSteps: [
  ...
  statuses: [
    { code: "AUTHENTIC", label: "Los datos coinciden con la prueba de integridad activa registrada on-chain" },
